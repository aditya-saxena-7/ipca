...
for fold_idx, (train_index, test_index) in enumerate(kf.split(time_index), start=1):
    ...
    print(f"\nFold {fold_idx} - Model Convergence Details:")
    #print(f"Number of Iterations: {ipca.n_iter_}")
    #print(f"Final Aggregate Update: {ipca.aggregate_update_}")
    ...
    print(f"Proportion of Variance Explained: {explained_variance / total_variance * 100:.2f}%")
